...
export const metadata = {
  title: "Sign up",
  description: "Create a School of Mentors AI account.",
  ...
  return (
    <div className="min-h-svh flex bg-[#1a1a1a]">
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <main className="flex-1 min-h-0 flex items-center justify-center overflow-y-auto py-5" aria-label="Sign up">
      ...
      <div className="hidden lg:flex flex-1 min-h-svh flex-col items-center justify-center gap-3 bg-[#141414] p-8 flex-shrink-0">
        <Link href="/" className="focus-visible:outline-none focus-visible:ring-0 rounded-lg no-underline block w-fit">
          <Image src="/logo.png" alt="School of Mentors AI" width={256} height={256} draggable={false}
            className="logo-no-drag w-48 h-48 lg:w-64 lg:h-64 object-contain [mix-blend-mode:multiply] dark:[mix-blend-mode:normal] select-none pointer-events-none" priority />
        </Link>
      </div>
    </div>
  );
